shivam@123 RLY_RAGHU_AP  192.168.168.5#include <iostream>
#include <vector>
#include <string>
    ...
    do {
        ...
        switch (choice) {
            ...
            case 2:
                ...
                cin >> taskIndex;
                todoList.markTaskCompleted(taskIndex - 1); // Convert to 0-based index
                break;
            case 3:
                cout << "Enter task index to remove: ";
                cin >> taskIndex;
                todoList.removeTask(taskIndex - 1); // Convert to 0-based index
                break;
            case 4:
